...
class FavoriteCardMenu extends StatefulWidget {
  FavoriteCardMenu({
    super.key,
  });

  @override
  State<FavoriteCardMenu> createState() => _FavoriteCardMenuState();
}

class _FavoriteCardMenuState extends State<FavoriteCardMenu> {
  int amount = 0;
