...
// Widget botNav() {
  ...
  //           children: <Widget>[
  //             navDest('assets/images/icons/home.png', 'Beranda', 0),
  //             navDest('assets/images/icons/pesanan.png', 'pesanan', 1),
  //             navDest('assets/images/icons/bantuan.png', 'bantuan', 2),
  //             navDest('assets/images/icons/profile.png', 'profile', 3),
  //           ],
  //         ),
  //       ),
  //     ),
  ...
  //   //             img,
  //   //             width: 24,
  //   //             color: currentPageIndex == idx ? primary4 : gray,
  //   //           ),
  //   //           onPressed: () {
  //   //             setState(() {
  ...
  //       img,
  //       width: 24,
  //       color: currentPageIndex == idx ? primary4 : outline,
  //     ),
  //     onPressed: () {
  //       setState(() {
  //         currentPageIndex = idx;
